...
Public Class Helper
    ...
    Public Shared Sub WriteDebugInfoAndFailed(ByVal addThisText As String)
        ...
        If Convert.ToBoolean(RegKey.GetValue(Of String)(RegKey.Pastebin)) Then
            Dim upload As MsgBoxResult = MsgBox("He's dead Jim?", vbYesNo)
    ...
    Public Shared Sub SelectPso2Directory()
        Try
            ...
            myFolderBrowser.Description = "Select your PSO2 bin folder."
            ...
            WriteDebugInfoAndOk(Program.Pso2RootDir & " " & "SetAsYourPSO2")

        Catch ex As Exception
            Log(ex.Message.ToString & " Stack Trace: " & ex.StackTrace)
            WriteDebugInfo("ERROR" & ex.Message)
        End Try
    End Sub
End Class