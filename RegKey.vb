...
Public Class RegKey
    ...
    Public Const NewPluginVersion = "NewPluginVersion"
    Public Const NewPluginVersionTemp = "NewPluginVersionTemp"
    ...
    Public Const PluginVersion = "PluginVersion"
    ...
    Private Shared ReadOnly RegistrySubKey As RegistryKey = Registry.CurrentUser.OpenSubKey("Software\Koi", True)
    ...
    Public Shared Sub SetValue(Of T)(key As String, value As T)
        My.Computer.Registry.SetValue("HKEY_CURRENT_USER\Software\Koi", key, value)
